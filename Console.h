...
class Console
{ // Ra: klasa statyczna gromadz¹ca sygna³y steruj¹ce oraz
    // informacje zwrotne
  ...
  private:
    ...
    // zmienne dla trybu "jednokabinowego", potrzebne do wspó³pracy z pulpitem
    // (PoKeys)
    ...
    static int iButton[8]; // monostabilne w kabinie, za³¹czane podczas trzymania
    // klawisza
